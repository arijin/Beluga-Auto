...
//--------------------------plots
static inline std::vector<cv::Scalar> color_list = {cv::Scalar(31, 119, 180),
...
static inline void plot_one_box(cv::Mat img, cv::Rect bbox, std::string label, cv::Scalar color, int line_thickness = 2)
{
    //bbox
...
static inline void plot_one_image(cv::Mat image, std::vector<cv::Rect> bboxes,
